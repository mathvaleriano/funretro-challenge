...
This project is a challenge of FunRetro Company.

The objective is retrieve information (name, location, image, state and a brief description) about some beautiful brazilian beaches. They can be filtered by State.
